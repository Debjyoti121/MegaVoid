                                ...
                                <View style={styles.iotRow}>
                                    ...
                                    <View style={styles.rowRight}>
                                        <View style={styles.smallMetric}>
                                            <LottieView source={require('../../assets/animations/temperature.json')} style={styles.smallIcon} autoPlay loop speed={0.8} resizeMode="contain" />
                                        ...
                                        <View style={styles.smallMetric}>
                                            <LottieView source={require('../../assets/animations/clouds.json')} style={styles.smallIcon} autoPlay loop speed={0.8} resizeMode="contain" />
                                            <Text style={styles.smallLabel}>Humidity</Text>
                                            <Text style={styles.smallValue}>{iotService.formatHumidity(iotData.humidity)}</Text>
                                        </View>

                                        <View style={styles.smallMetric}>
                                            <LottieView source={require('../../assets/animations/Seedling.json')} style={styles.smallIcon} autoPlay loop speed={0.8} resizeMode="contain" />
